...
acceldata = linedrawer2.linedrawer()
onoff = plot.p1()
...
#print SpatialData.accelerationarray 
print("Closing...")
#print SpatialData.acceldata.accelerationarray
